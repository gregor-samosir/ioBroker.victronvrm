...
const BATTERY_SENSORS = [
 ...
 // Alarms
 { id: 'battery.alarms.lowVoltage', name: { en: 'Low Voltage Alarm', de: 'Alarm: Unterspannung' }, vrmId: 119, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.highVoltage', name: { en: 'High Voltage Alarm', de: 'Alarm: Überspannung' }, vrmId: 120, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.lowStarterVoltage', name: { en: 'Low Starter Voltage Alarm', de: 'Alarm: Starterbatt. zu niedrig' }, vrmId: 121, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.highStarterVoltage', name: { en: 'High Starter Voltage Alarm', de: 'Alarm: Starterbatt. zu hoch' }, vrmId: 122, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.lowSoc', name: { en: 'Low SoC Alarm', de: 'Alarm: SoC zu niedrig' }, vrmId: 123, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.lowTemperature', name: { en: 'Low Temperature Alarm', de: 'Alarm: Temp. zu niedrig' }, vrmId: 124, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.highTemperature', name: { en: 'High Temperature Alarm', de: 'Alarm: Temp. zu hoch' }, vrmId: 125, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.midVoltage', name: { en: 'Mid Voltage Alarm', de: 'Alarm: Mid-Voltage' }, vrmId: 126, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.lowFusedVoltage', name: { en: 'Low Fused Voltage Alarm', de: 'Alarm: Gesich.-Spg. niedrig' }, vrmId: 155, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.highFusedVoltage', name: { en: 'High Fused Voltage Alarm', de: 'Alarm: Gesich.-Spg. hoch' }, vrmId: 156, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.fuseBlown', name: { en: 'Fuse Blown Alarm', de: 'Alarm: Sicherung ausgelöst' }, vrmId: 157, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.highInternalTemp', name: { en: 'High Internal Temp Alarm', de: 'Alarm: Innentemperatur hoch' }, vrmId: 158, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.cellImbalance', name: { en: 'Cell Imbalance Alarm', de: 'Alarm: Zellungleichgewicht' }, vrmId: 286, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.highChargeCurrent', name: { en: 'High Charge Current Alarm', de: 'Alarm: Ladestrom zu hoch' }, vrmId: 287, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.highDischargeCurrent',name: { en: 'High Discharge Current Alarm',de: 'Alarm: Entladestrom zu hoch' }, vrmId: 288, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.internalFailure', name: { en: 'Internal Failure Alarm', de: 'Alarm: Interner Fehler' }, vrmId: 289, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.highChargeTemp', name: { en: 'High Charge Temp Alarm', de: 'Alarm: Ladetemp. zu hoch' }, vrmId: 459, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.lowChargeTemp', name: { en: 'Low Charge Temp Alarm', de: 'Alarm: Ladetemp. zu niedrig' }, vrmId: 460, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.lowCellVoltage', name: { en: 'Low Cell Voltage Alarm', de: 'Alarm: Zellspannung niedrig' }, vrmId: 522, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.chargeBlocked', name: { en: 'Charge Blocked (BMS)', de: 'Laden gesperrt (BMS)' }, vrmId: 739, unit: '', type: 'boolean', role: 'sensor.alarm' },
 { id: 'battery.alarms.dischargeBlocked', name: { en: 'Discharge Blocked (BMS)', de: 'Entladen gesperrt (BMS)' }, vrmId: 740, unit: '', type: 'boolean', role: 'sensor.alarm' },
];
...
const PVINVERTER_SENSORS = [
 ...
 // vrmId 112 = system-level aggregate (Pi, instance=0) — sums all registered PV inverters
 { id: 'pvInverter.powerL1', name: { en: 'PV Power L1', de: 'PV Leistung L1' }, vrmId: 112, unit: 'W', type: 'number', role: 'value.power' },
 ...
 // vrmId 129 = system-level aggregate (Pi2, instance=0)
 { id: 'pvInverter.powerL2', name: { en: 'PV Power L2', de: 'PV Leistung L2' }, vrmId: 129, unit: 'W', type: 'number', role: 'value.power' },
 ...
 // vrmId 130 = system-level aggregate (Pi3, instance=0)
 { id: 'pvInverter.powerL3', name: { en: 'PV Power L3', de: 'PV Leistung L3' }, vrmId: 130, unit: 'W', type: 'number', role: 'value.power' },
...
// Optional compatibility aliases that mirror overall.* today values.
const LEGACY_ENERGY_ALIAS_STATE_IDS = [
 'battery.energyToConsumersToday',
 'battery.energyToGridToday',
 'pvInverter.energyToConsumersToday',
 'pvInverter.energyToBatteryToday',
 'pvInverter.energyToGridToday',
 'multiplus.energyGridToConsumersToday',
 'multiplus.energyGridToBatteryToday',
];
